...
public class Oven extends Appliance {
	...
	public String getDerth() {
		return derth;
	}

	public void setDerth(String derth) {
		this.derth = derth;
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((derth == null) ? 0 : derth.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (derth == null) {
			if (other.derth != null)
				return false;
		} else if (!derth.equals(other.derth))
			return false;
		if (height == null) {
	...
	public String toString() {
		return "Oven [powerConsumption=" + powerConsumption + ", weight=" + weight + ", capacity=" + capacity
				+ ", derth=" + derth + ", height=" + height + ", width=" + width + "]";
	}
